...
export default function BoysHostelOrganogramPage() {
  const [expandedDepartments, setExpandedDepartments] = useState<{[key: string]: boolean}>({})

  const hostelInfo = {
    name: "Boys Hostel Organizational Structure",
    tagline: "Comprehensive management structure for efficient hostel operations",
    established: "2010",
    warden: "Dr. James Anderson",
    capacity: "500 students",
    description: "The Boys Hostel operates under a well-defined organizational structure that ensures smooth administration, student welfare, and maintenance of high standards in hostel life and facilities.",
    mission: "To provide a safe, supportive, and disciplined living environment that fosters academic excellence, personal growth, and community development among resident students."
  }
  ...
  const organizationalStructure = [
      ...
      members: [
        {
          ...
          role: "Chief Warden",
          image: "/staff/james-anderson.jpg",
          email: "james.anderson@college.edu",
          phone: "+1 234-567-8901",
          responsibilities: ["Overall hostel administration", "Policy implementation", "Student discipline", "Staff supervision"],
          qualifications: ["PhD in Education Administration", "15+ years experience", "Certified Student Affairs Professional"],
        ...
        },
        {
          ...
          role: "Deputy Warden",
          image: "/staff/robert-williams.jpg",
          email: "robert.williams@college.edu",
          phone: "+1 234-567-8902",
          responsibilities: ["Assist Chief Warden", "Student welfare", "Event coordination", "Parent communication"],
          qualifications: ["Masters in Counseling", "10+ years experience", "Student Development Specialist"],
      ...
      members: [
        {
          ...
          responsibilities: ["Room allocation", "Fee management", "Record keeping", "Student registration"],
          qualifications: ["BBA in Administration", "8+ years experience", "Certified Office Manager"],
        ...
        },
        {
          ...
          image: "/staff/michael-brown.jpg",
          email: "michael.brown@college.edu",
          phone: "+1 234-567-8904",
          responsibilities: ["Fee collection", "Budget management", "Financial reporting", "Expense tracking"],
          qualifications: ["M.Com in Finance", "6+ years experience", "Certified Accountant"],
      ...
      members: [
        {
          ...
          image: "/staff/david-lee.jpg",
          email: "david.lee@college.edu",
          phone: "+1 234-567-8905",
          responsibilities: ["Floor supervision", "Student discipline", "Night duty", "Emergency response"],
          qualifications: ["Masters in Social Work", "12+ years experience", "Certified Counselor"],
        ...
        },
        {
          ...
          responsibilities: ["Student mentoring", "Activity coordination", "Floor management", "Attendance tracking"],
          qualifications: ["Masters in Psychology", "8+ years experience", "Student Mentor"],
      ...
      members: [
        {
          ...
          qualifications: ["Diploma in Engineering", "10+ years experience", "Certified Maintenance Professional"],
          office: "Maintenance Office, Ground Floor",
          hours: "8:00 AM - 6:00 PM"
        },
        {
          name: "Mr. Richard Martinez",
          role: "Security Supervisor",
          image: "/staff/richard-martinez.jpg",
          email: "richard.martinez@college.edu",
          phone: "+1 234-567-8908",
          responsibilities: ["Security management", "Access control", "Emergency response", "Surveillance monitoring"],
          qualifications: ["Security Training Certificate", "15+ years experience", "Licensed Security Professional"],
    ...
    },
    {
      ...
      members: [
        {
          name: "Ms. Linda Anderson",
          role: "Housekeeping Supervisor",
          image: "/staff/linda-anderson.jpg",
          email: "linda.anderson@college.edu",
          phone: "+1 234-567-8909",
          responsibilities: ["Cleaning supervision", "Room inspections", "Linen management", "Sanitation standards"],
          qualifications: ["Diploma in Hospitality", "8+ years experience", "Housekeeping Management Certificate"],
        ...
        },
        {
          ...
          image: "/staff/charles-thompson.jpg",
          email: "charles.thompson@college.edu",
          phone: "+1 234-567-8910",
          responsibilities: ["Food quality control", "Menu planning", "Kitchen management", "Nutrition standards"],
          qualifications: ["Diploma in Food Technology", "12+ years experience", "Food Safety Certified"],
  ...
  const studentLeadership = [
    {
      ...
      members: [
        { name: "Alex Johnson", role: "Hostel President", floor: "Block A, Floor 3" },
        { name: "Michael Chen", role: "Cultural Secretary", floor: "Block A, Floor 2" },
        { name: "David Williams", role: "Sports Secretary", floor: "Block B, Floor 1" },
        { name: "Robert Brown", role: "Discipline Committee", floor: "Block A, Floor 4" }
      ]
    },
    {
      ...
      members: [
        { name: "James Lee", role: "Floor 1 Representative", floor: "Block A, Floor 1" },
        { name: "Thomas Garcia", role: "Floor 2 Representative", floor: "Block A, Floor 2" },
        { name: "Richard Martinez", role: "Floor 3 Representative", floor: "Block A, Floor 3" },
        { name: "Charles Thompson", role: "Floor 4 Representative", floor: "Block A, Floor 4" }
      ]
    }
  ]
