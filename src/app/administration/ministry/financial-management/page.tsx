...
import { Users, Target, Calendar, Mail, Phone, MapPin, Landmark, BadgeCheck, Wallet, LineChart } from "lucide-react"

export default function FinancialManagementCommitteeByMinistryPage() {
  const committeeMembers = [
    {
      name: "Prof. Dr. M. A. Rahman",
      designation: "Chairman",
      affiliation: "Financial Oversight (Ministry)",
      avatar: "MR",
    ...
    },
    {
      name: "Dr. N. A. Begum",
      designation: "Member",
      affiliation: "Procurement & Governance",
      avatar: "NB",
  ...
  const responsibilities = [
    "Review institutional budgets and financial plans",
    "Ensure compliance with relevant financial policies and rules",
    "Monitor expenditure, revenue, and financial controls",
    "Oversee procurement transparency and accountability",
  ...
  const operations = [
    {
      title: "Budget Review",
      value: "Quarterly",
      description: "Budget performance, allocation, and revisions",
    ...
    },
    {
      ...
      value: "Ongoing",
      description: "Audit observations, actions, and documentation",
    ...
    },
    {
      title: "Procurement",
      value: "As Needed",
      description: "Compliance checks for major procurements",
    ...
    },
    {
      title: "Reporting",
      value: "Periodic",
      description: "Financial reporting to stakeholders",
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex justify-center mb-8">
              <div className="w-24 h-24 bg-white/70 backdrop-blur-md rounded-full flex items-center justify-center shadow-xl">
                <Landmark className="w-12 h-12 text-green-700" />
              </div>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Financial Management Committee (By Ministry)</h1>
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed">Budget, audit, and financial governance oversight</p>
            <div className="mt-8 flex justify-center">
              <div className="bg-white text-gray-700 px-6 py-2 rounded-full text-lg font-semibold shadow-md">Transparency & Accountability</div>
            </div>
          </div>
        </div>
      </div>
                ...
                <CardContent className="p-8">
                  <div className="prose prose-lg max-w-none">
                    <p className="text-gray-700 leading-relaxed mb-6">
                      The Financial Management Committee (By Ministry) supports strong financial governance at Rangpur Community Medical
                      College & Hospital by reviewing financial plans, monitoring budget performance, ensuring compliance, and promoting
                      transparency in financial operations.
                    </p>
                    <p className="text-gray-700 leading-relaxed">
                      The committee reviews audit observations, oversees follow-up actions, and recommends improvements to strengthen
                      internal control systems and effective resource utilization.
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      To ensure responsible financial management aligned with policy and compliance requirements.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-br from-blue-50 to-indigo-50">
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">Budget discipline, audit readiness, and control systems.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                  For official communication related to the Financial Management Committee, please use the following contact information.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
                  ...
                  <div className="flex items-center justify-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">financial.management@rcmc.edu.bd</p>
                    </div>
                  </div>
                </div>
