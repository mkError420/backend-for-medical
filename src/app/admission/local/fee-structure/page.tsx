...
export default function FeeStructurePage() {
  ...
  const additionalFees = [
    { name: "Hostel Fees (Optional)", amount: "৳60,000/year", description: "Accommodation with meals" },
    { name: "Transportation (Optional)", amount: "৳12,000/year", description: "Bus service facility" },
    { name: "Lab Coat & Equipment", amount: "৳5,000 (one-time)", description: "Required for practical sessions" },
    { name: "Study Materials", amount: "৳8,000/year", description: "Books and reference materials" },
    { name: "Examination Fees", amount: "৳15,000/year", description: "Internal and external exams" },
    { name: "Internship Fees", amount: "৳50,000", description: "Final year internship" }
  ]

  const scholarshipCategories = [
    {
      name: "Merit Scholarship",
      criteria: "SSC+HSC GPA 9.5+",
      benefit: "25% tuition waiver",
      students: "Top 10 students"
    },
    {
      name: "Need-Based Scholarship",
      criteria: "Family income < ৳200,000/year",
    ...
    },
    {
      ...
      students: "Selected candidates"
    },
    {
      name: "Women in Medicine",
      criteria: "Female students with GPA 8.5+",
      benefit: "10% tuition waiver",
      students: "Top 20 female students"
    }
  ]
  ...
  const handleDownloadFeeStructure = () => {
    ...
    <html>
    <head>
        <title>MBBS Fee Structure - 2025-2026</title>
        <style>
            body { 
    ...
    <body>
        <h1>MBBS PROGRAM FEE STRUCTURE</h1>
        ...
        <div class="contact">
            ...
            <div class="fee-item"><span>Finance Department</span><span>+880-2-XXXXXXX</span></div>
            <div class="fee-item"><span>Email</span><span>finance@medicalcollege.edu.bd</span></div>
            <div class="fee-item"><span>Website</span><span>www.medicalcollege.edu.bd</span></div>
        </div>
        
        <div class="footer">
            <p>Generated on: ${new Date().toLocaleDateString()}</p>
            <p>Medical College Bangladesh - MBBS Admission Portal</p>
        </div>
    </body>
    </html>
    `.trim()
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="mb-8">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight text-gray-800">
                Fee Structure
                <span className="block text-3xl md:text-4xl text-gray-600 mt-2">Transparent & Affordable</span>
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Comprehensive breakdown of MBBS program fees with flexible payment options
              </p>
            </div>
            <div className="flex flex-wrap gap-4 justify-center mb-8">
              ...
              <Button size="lg" className="bg-green-600 hover:bg-green-700 px-8 py-4 text-lg font-semibold shadow-lg transform hover:scale-105 transition-all duration-200" onClick={handleDownloadFeeStructure}>
                ...
                <Card key={plan.id} className={`shadow-xl hover:shadow-2xl transition-all duration-300 border-0 bg-white overflow-hidden cursor-pointer ${selectedPlan === plan.id ? 'ring-2 ring-purple-500 transform scale-105' : ''}`} onClick={() => setSelectedPlan(plan.id)}>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center text-sm">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                        <span className="text-gray-700">Flexible payment methods</span>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Various scholarship programs to support deserving students
              </p>
            </div>
      ...
      <div className="bg-gradient-to-b from-white to-gray-50 py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="shadow-lg hover:shadow-xl transition-all duration-300 border-0 bg-white text-center p-6">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <CreditCardIcon className="h-8 w-8 text-blue-600" />
                </div>
                <h3 className="font-semibold text-gray-800 mb-2">Bank Payment</h3>
                <p className="text-sm text-gray-600">Pay directly at designated banks</p>
              </Card>
              ...
              <Card className="shadow-lg hover:shadow-xl transition-all duration-300 border-0 bg-white text-center p-6">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Mobile Banking</h3>
                <p className="text-sm text-gray-600">bKash, Nagad, Rocket available</p>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Need Help with Fee Information?</h3>
              <p className="text-blue-100 mb-6">
                Our finance department is here to assist you with any fee-related queries
              </p>
